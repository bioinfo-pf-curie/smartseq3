...
## Header
#Table:
echo -e "Sample_id,Sample_name,Number_of_fragments,Percent_UMIs,Percent_Aligned,Percent_Assigned,Number_of_UMIs,Number_of_genes_umi,Number_of_reads,Number_of_genes_read" > table_mqc.stats
#Bargraph:
